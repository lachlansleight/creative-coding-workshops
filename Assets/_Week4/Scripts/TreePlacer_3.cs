...
public class TreePlacer_3 : MonoBehaviour
{
    [Header("Positioning")]
    public Vector2 Start = new Vector2(-125f, -125f);
    public Vector2 Size = new Vector2(250f, 250f);
    public float MaxHeight = 150f; //this is my terrain height
    ...
    public float TreeMaxHeight = 40f;
    ...
    public void Spawn(int count)
    {
        ...
        for (var i = 0; i < count; i++) {
            ...
            if (hit.point.y > TreeMaxHeight) continue;
